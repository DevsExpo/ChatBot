...
from chatrobot.plugins.sql.checkuser_sql import already_added
from chatrobot.plugins.sql.checkuser_sql import get_all_users
from chatrobot.plugins.sql.users_sql import add_me_in_db
from chatrobot.plugins.sql.users_sql import his_userid
...
async def help(event):
    if event.query.user_id is not Config.OWNER_ID:
        await event.edit(
            ...
            buttons=[
                [Button.url("Join my owner channel", "t.me/Infotel14")],
